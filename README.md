...
Vannak-e VNet-jeim?
	...
	az network vnet list --resource-group "EROFORRASCSOPORT NEVE" --output table   --- ha csak axxx erőforráscsoportban lévőket akarom lekérdezni
...
Subnet létrehozás:
	az network vnet subnet create --resource-group "EROFORRASCSOPORT NEVE" --vnet-name "VNet neve" --name "SubNet neve" --address-prefixes 10.0.0.0/24       ----kötlező az address-prefixes
